...
for (
  var select = document.getElementById("input-select"), i = -20;
  i <= 40;
  i++
) {
...
html5Slider.noUiSlider.on("update", function (e, t) {
  var n = e[t];
  t ? (inputNumber.value = n) : (select.value = Math.round(n));
}),
...
function crossUpdate(e, t) {
  var n;
  lockedState &&
    ((e -= lockedValues[(n = slider1 === t ? 0 : 1) ? 0 : 1] - lockedValues[n]),
    t.noUiSlider.set(e));
}
