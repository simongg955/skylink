      ...
      },
      {
        ...
        formatter: function (a) {
          switch (a) {
            case "Mastercard":
              return gridjs.html(
                '<i class="fab fa-cc-mastercard me-2"></i>' + a
              );
            case "Visa":
              return gridjs.html('<i class="fab fa-cc-visa me-2"></i>' + a);
            case "Paypal":
              return gridjs.html('<i class="fab fa-cc-paypal me-2"></i>' + a);
            case "COD":
              return gridjs.html(
                '<i class="fas fa-money-bill-alt me-2"></i>' + a
              );
          }
        },
      },
