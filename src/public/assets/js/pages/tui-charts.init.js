...
window.onresize = function () {
  barChart.resize({ width: columnChartWidth, height: 350 });
};
...
window.onresize = function () {
  barChart.resize({ width: lineChartWidth, height: 350 });
};
...
window.onresize = function () {
  barChart.resize({ width: areaChartWidth, height: 350 });
};
...
window.onresize = function () {
  barChart.resize({ width: radialChartWidth, height: 350 });
};
...
window.onresize = function () {
  barChart.resize({ width: bubbleChartWidth, height: 350 });
};
...
window.onresize = function () {
  barChart.resize({ width: scatterChartWidth, height: 350 });
};
...
window.onresize = function () {
  barChart.resize({ width: pieChartWidth, height: 350 });
};
...
window.onresize = function () {
  barChart.resize({ width: donutpieChartWidth, height: 350 });
};
var barchartColors = getChartColorsArray("heatmap-charts"),
  heatmapchartsWidth = document.getElementById("heatmap-charts").offsetWidth,
...
window.onresize = function () {
  barChart.resize({ width: heatmapChartChartWidth, height: 350 });
};
var barchartColors = getChartColorsArray("treemap-charts"),
  treemapchartsWidth = document.getElementById("treemap-charts").offsetWidth,
...
window.onresize = function () {
  barChart.resize({ width: treemapChartChartWidth, height: 350 });
};
var barchartColors = getChartColorsArray("map-charts"),
  mapchartsWidth = document.getElementById("map-charts").offsetWidth,
...
window.onresize = function () {
  barChart.resize({ width: mapChartChartWidth, height: 350 });
};
var barchartColors = getChartColorsArray("boxplot-charts"),
  boxplotchartsWidth = document.getElementById("boxplot-charts").offsetWidth,
...
window.onresize = function () {
  barChart.resize({ width: boxplotChartChartWidth, height: 350 });
};
var barchartColors = getChartColorsArray("bullet-charts"),
  bulletchartsWidth = document.getElementById("bullet-charts").offsetWidth,
...
window.onresize = function () {
  barChart.resize({ width: bulletChartWidth, height: 350 });
};
