...
(barchartColors = getChartColorsArray("area_chart_basic")),
  (options = {
...
(barchartColors = getChartColorsArray("basic_candlestick")),
  (options = {
    series: [
      {
        data: [
    ...
    plotOptions: {
      candlestick: {
        colors: { upward: barchartColors[0], downward: barchartColors[1] },
      },
    },
    title: {
...
(barchartColors = getChartColorsArray("combo_candlestick")),
  (options = {
  ...
  optionsBar = {
    ...
    plotOptions: {
      bar: {
        ...
        colors: {
          ranges: [
            { from: -1e3, to: 0, color: barchartColors[0] },
            { from: 1, to: 1e4, color: barchartColors[1] },
          ],
        },
      },
    },
...
(barchartColors = getChartColorsArray("box_plot")),
  (options = {
    series: [
      {
        name: "Box",
    ...
    plotOptions: {
      boxPlot: {
        colors: { upper: barchartColors[0], lower: barchartColors[1] },
      },
    },
...
(barchartColors = getChartColorsArray("monochrome_polar_area")),
  (options = {
